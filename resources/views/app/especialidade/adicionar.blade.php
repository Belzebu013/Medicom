...
<div class="conteudo-pagina">
   ...
   <div class="menu">
      <ul>
         <li><a href="{{ route('especialidade.index', ['especialidades'=>$especialidades]) }}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-in-left" viewBox="0 0 16 16">
